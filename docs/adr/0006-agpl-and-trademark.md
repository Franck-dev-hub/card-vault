# License the code under AGPL-3.0 and protect the brand
...
- MIT: a closed hosted clone would owe nothing back.
- GPL-3.0: same gap, since hosting a service is not distributing it.
- FSL (Functional Source License): blocks competing deployments, but is not open
  source.

## Consequences

- Changing the licence later needs the consent of every contributor whose code
  is merged.
